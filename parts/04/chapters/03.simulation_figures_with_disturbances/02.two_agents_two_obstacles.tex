...
\begin{minipage}{\linewidth}
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]
      \scalebox{0.6}{\input{./figures/07.with_disturbances/2_2/02.errors/errors_agent_1.tex}}
  ...
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]
      \scalebox{0.6}{\input{./figures/07.with_disturbances/2_2/02.errors/errors_agent_2.tex}}
...
\begin{minipage}{\linewidth}
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]
      \scalebox{0.6}{\input{./figures/07.with_disturbances/2_2/03.distances/distance_obstacle_1_agents.tex}}
  ...
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]
      \scalebox{0.6}{\input{./figures/07.with_disturbances/2_2/03.distances/distance_obstacle_2_agents.tex}}
...
\begin{minipage}{\linewidth}
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]
      \scalebox{0.6}{\input{./figures/07.with_disturbances/2_2/04.inputs/inputs_agent_1.tex}}
  ...
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]
      \scalebox{0.6}{\input{./figures/07.with_disturbances/2_2/04.inputs/inputs_agent_2.tex}}
...
\begin{minipage}{\linewidth}
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]
      \scalebox{0.6}{\input{./figures/07.with_disturbances/2_2/05.V/V.tex}}
      \caption{}
      \label{}
    \end{figure}
  \end{minipage}
  ...
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]
      \scalebox{0.6}{\input{./figures/07.with_disturbances/2_2/05.V/V_zoom.tex}}
      \caption{}
      \label{}
    \end{figure}
  \end{minipage}
