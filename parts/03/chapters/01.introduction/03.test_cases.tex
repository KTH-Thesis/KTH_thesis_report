...
\begin{enumerate}
  \item Two agents will have to avoid one obstacle on their way to their
    ...
    smaller than the obstacle's diameter for the sake of cooperation).
  \item Two agents will have to pass through the space between two obstacles
    ...
    of the obstacle with the smallest diameter.
...
red and agent 3 in green. The obstacles shall be depicted in black. Mark X
...
\begin{minipage}{\linewidth}
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]
      \scalebox{0.7}{\input{./figures/05.test_cases/conf_2_1.tex}}
      \caption{Two agents and one obstacle. X's mark the desired position
        of each agent in steady-state.}
  ...
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]
      ...
      \caption{Two agents and two obstacles. X's mark the desired position
        of each agent in steady-state.}
...
\begin{minipage}{\linewidth}
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]
      ...
      \caption{Three agents and one obstacle. X's mark the desired position
        of each agent in steady-state.}
  ...
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]
      ...
      \caption{Three agents and two obstacles. X's mark the desired position
        of each agent in steady-state.}
...
In the case of two agents, the neighbouring sets are $\mathcal{N}_1 = \{2\}$
and $\mathcal{N}_2 = \{1\}$, while in the case of three agents,
$\mathcal{N}_1 = \{2,3\}$, $\mathcal{N}_2 = \{1\}$ and $\mathcal{N}_3 = \{1\}$.
...
of the obstacles and various other parameters $-$ such as the penalty matrices
$\mat{Q}, \mat{R}, \mat{P}$ $-$ shall be reported in the appropriate sections.
