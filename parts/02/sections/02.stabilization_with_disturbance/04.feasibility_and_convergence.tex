...
\begin{theorem}
  ...
  \begin{enumerate}
    ...
    \item assumptions \eqref{ass:phi_psi} and \eqref{ass:psi_omega} hold true
...
\end{align}
Consulting with property \eqref{property:restricted_constraint_set}
\begin{align}
  \overline{\vect{e}}_i\big(t_{k+1} + s;\ \overline{\vect{u}}_i^{\star}(\cdot), \vect{e}_i(t_{k+1})\big) \in \mathcal{E}_i \ominus \mathcal{B}_{i,s}\
    \Rightarrow\
    \vect{e}_i\big(t_{k+1} + s;\ \overline{\vect{u}}_i^{\star}(\cdot), \vect{e}_i(t_{k+1})\big) \in \mathcal{E}_i
