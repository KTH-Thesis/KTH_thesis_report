...
\begin{theorem}
  ...
  \begin{enumerate}
    ...
    \item assumptions \eqref{ass:g_i_g_R_Lipschitz},  \eqref{ass:phi_psi},
      \eqref{ass:psi_omega} and \eqref{ass:existence_of_solutions_with_disturbance}
      hold true
...
implications\footnote{For more details see the discussion after the
