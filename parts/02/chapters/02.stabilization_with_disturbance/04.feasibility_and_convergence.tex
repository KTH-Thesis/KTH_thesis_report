...
Finally, $\overline{\vect{e}}_i\big(t_{k+1} + T_p;\ \widetilde{\vect{u}}_i(\cdot), \vect{e}_i(t_{k+1}) \big) \in \Omega_i$.\\[1ex]
\begin{gg_box}
...
given assumptions \eqref{ass:phi_psi} and \eqref{ass:psi_omega},
and assumption 4 of theorem \eqref{theorem:with_disturbances}, the closed-loop
