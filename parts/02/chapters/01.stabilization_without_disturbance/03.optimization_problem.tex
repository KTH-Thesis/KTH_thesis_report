...
\begin{align}
  ...
  \text{subject to:} & \nonumber \\[2.5ex]
                     ...
                     & \overline{\vect{u}}_i(s) \in \mathcal{U}_i,\ \overline{\vect{e}}_i (s) \in \mathcal{E}_{i,s},\ s \in [t_k, t_k + T_p]\\[2.5ex]
...
his predicted configuration at times $\tau \in [t_k, t_k + T_p]$ is
constrained by the predicted configuration of its neighbouring or
