...
are portrayed, along with its input signals and the distances between all
...
All simulations were performed with a sampling time of $h = 0.1$ sec, and
...
\begin{figure}[H]
  \scalebox{0.9}{\input{./figures/06.without_disturbance/2_1/01.trajectories/trajectory_d_OFF_2_1.tex}}
