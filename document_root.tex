...
\part{Advocated Solution}
  ...
  \section{Stabilization}
    ...
    \input{parts/02/sections/02.stabilization/01.model.tex}
    \input{parts/02/sections/02.stabilization/02.error_model.tex}
    \input{parts/02/sections/02.stabilization/03.receding_horizon_control.tex}
    \input{parts/02/sections/02.stabilization/04.optimization_problem.tex}
    \input{parts/02/sections/02.stabilization/05.feasibility_and_convergence.tex}
    \cleardoublepage
