...
\part{Advocated Solution}
  ...
  \section{Stabilization}
    ...
    \input{parts/02/sections/02.stabilization/01.error_model.tex}
    \input{parts/02/sections/02.stabilization/02.optimization_problem.tex}
    \input{parts/02/sections/02.stabilization/03.feasibility_and_convergence.tex}
    %\cleardoublepage
