...
\title{\textbf{
%A Distributed Nonlinear Model Predictive Control Scheme for
...
%-------------------------------------------------------------------------------
  \section{Notation and Preliminaries}
    ...
    \input{parts/01/sections/01.notation_and_preliminaries/02.auxiliary_prerequisites.tex}
...
%-------------------------------------------------------------------------------
  \section{Disturbance-free Stabililization}
    \label{sec:stabilization_without_disturbance}

    \input{parts/02/sections/01.stabilization_without_disturbance/01.model.tex}
    \input{parts/02/sections/01.stabilization_without_disturbance/02.error_model.tex}
    \input{parts/02/sections/01.stabilization_without_disturbance/03.optimization_problem.tex}
    \input{parts/02/sections/01.stabilization_without_disturbance/04.feasibility_and_convergence.tex}
    \cleardoublepage
...
%-------------------------------------------------------------------------------
  \section{Stabilization in the face of Disturbances}
    ...
    \input{parts/02/sections/02.stabilization_with_disturbance/01.model.tex}
    \input{parts/02/sections/02.stabilization_with_disturbance/02.error_model.tex}
    \input{parts/02/sections/02.stabilization_with_disturbance/03.optimization_problem.tex}
    \input{parts/02/sections/02.stabilization_with_disturbance/04.feasibility_and_convergence.tex}
    \cleardoublepage
